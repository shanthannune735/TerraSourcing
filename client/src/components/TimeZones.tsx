export default function TimeZones({ handleChange }: { handleChange: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => void}){

  return(
    <select id="timezone" name="timeZone" onChange={handleChange} className="border p-2 border-gray-300 text-gray-500 rounded w-full max-w-[520px] lg:w-full text-md">
